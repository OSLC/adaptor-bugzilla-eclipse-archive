...
import static se.kth.md.it.bcm.servlet.ServletListener.getConfigurationProperty;
import static se.kth.md.it.bcm.servlet.ServletListener.getServletUrlPattern;
...
public class ApplicationBinder extends AbstractBinder {
    ...
    protected void configure() {
        ...
        // loadBugzillaProperties();

        // configureBugzillaInfo(properties);

        // final boolean storeEnabled = initialiseStore();

        // if (storeEnabled) {
        //     try {
        //         bugzillaChangeProvider = new BugzillaChangeProvider(bugzillaUsername,
        //             bugzillaPassword);
        //         // TODO: 2016-12-27 pass last update timestamp to changeprovider
        //         StoreUpdateManager<OSLCMessage> updateManager = new StoreUpdateManager<>(store,
        //             bugzillaChangeProvider);
        //         updateManager.addHandler(new SimpleHandler());
        //         updateManager.addHandler(new LastUpdateHandler<>(LAST_UPDATE_KEY));
        //         ZonedDateTime lastUpdateDate = getLastUpdateDate();
        //         updateManager.poll(lastUpdateDate, storeUpdateFrequency);
        //     } catch (ConnectionException | UnauthorizedException e) {
        //         log.error(
        //             "Failed to initialize BugzillaChangeProvider w/login '{}' (using password: {})",
        //             bugzillaUsername,
        //             new Object[]{Strings.isNullOrEmpty(bugzillaPassword) ? "NO" : "YES", e});
        //     }
        // }
        // End of user code
    }
