...
public class ServletListener implements ServletContextListener  {
    ...
    public void contextInitialized(final ServletContextEvent servletContextEvent)
    {
        ...
        RestDelegate.loadBugzillaProperties();

        // fixme
//        RestDelegate.configureBugzillaInfo(properties);
//
//        final boolean storeEnabled = initialiseStore();
//
//        if (storeEnabled) {
//            try {
//                bugzillaChangeProvider = new BugzillaChangeProvider(RestDelegate.bugzillaUsername,
//                        RestDelegate.bugzillaPassword);
