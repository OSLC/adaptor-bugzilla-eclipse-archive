...
import se.kth.md.it.bcm.ServerConstants;
...
// End of user code
@Path("bugz")
public class BugzillaCachedAdaptorService1
{
    ...
    private static final Logger log = LoggerFactory.getLogger(BugzillaCachedAdaptorService1.class);
    ...
    public BugzillaCachedAdaptorService1()
    {
        super();
    }
    ...
    @Operation(
        summary = "GET for resources of type {'" + BugzDomainConstants.BUGZILLACHANGEREQUEST_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + BugzDomainConstants.BUGZILLACHANGEREQUEST_TYPE + "\">" + BugzDomainConstants.BUGZILLACHANGEREQUEST_LOCALNAME + "</a>" + "'}" +
            ", with respective resource shapes {'" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + BugzDomainConstants.BUGZILLACHANGEREQUEST_PATH + "\">" + BugzDomainConstants.BUGZILLACHANGEREQUEST_LOCALNAME + "</a>" + "'}",
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final BugzillaChangeRequest aBugzillaChangeRequest = delegate.getBugzillaChangeRequest(httpServletRequest, bugId);

        if (aBugzillaChangeRequest != null) {
            // Start of user code getBugzillaChangeRequest
            // End of user code
            httpServletResponse.setHeader("ETag", delegate.getETagFromBugzillaChangeRequest(aBugzillaChangeRequest));
    ...
    public void getBugzillaChangeRequestAsHtml(
        @PathParam("bugId") final String bugId
