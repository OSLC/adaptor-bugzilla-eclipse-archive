...
// End of user code
@OslcService(BugzDomainConstants.BUGZILLA_NAMSPACE)
...
public class ServiceProviderService1
{
    ...
    @Operation(
        summary = "Query capability for resources of type {" + BugzDomainConstants.BUGZILLACHANGEREQUEST_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + BugzDomainConstants.BUGZILLACHANGEREQUEST_TYPE + "\">" + BugzDomainConstants.BUGZILLACHANGEREQUEST_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<BugzillaChangeRequest> resources = delegate.queryBugzillaChangeRequests(httpServletRequest, serviceProviderId, where, prefix, paging, page, pageSize);
    ...
    public void queryBugzillaChangeRequestsAsHtml(
                                    @PathParam("serviceProviderId") final String serviceProviderId ,
                                       @QueryParam("oslc.where") final String where,
                                       @QueryParam("oslc.prefix") final String prefix,
                                       @QueryParam("oslc.paging") final String pagingString,
