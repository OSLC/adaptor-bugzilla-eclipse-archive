...
<%@page import="se.kth.md.it.bcm.resources.Type"%>
<%@page import="java.net.URI"%>
<%
String asLocalResource = request.getParameter("asLocalResource");
Type aResource = null;
if (request.getParameter("resourceUri") != null) {
    aResource = new Type (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aType") != null) {
        aResource = (Type) request.getAttribute("aType");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Type Resource} - update Type.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
