...
if (request.getParameter("resourceUri") != null) {
    aResource = new BugzillaChangeRequest (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aBugzillaChangeRequest") != null) {
        aResource = (BugzillaChangeRequest) request.getAttribute("aBugzillaChangeRequest");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local BugzillaChangeRequest Resource} - update BugzillaChangeRequest.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
