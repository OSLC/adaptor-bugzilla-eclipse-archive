...
<html lang="en">
  <head>
    ...
    <title>Service Provider Catalog - Lyo Bugzilla adaptor (archives) OSLC Adapter</title>
  ...
  <div class="container">
    <div class="page-header">
      <h1>Lyo Bugzilla adaptor (archives) Service Provider Catalogue</h1>
    </div>
    ...
    <% if (catalog.getServiceProviders().length == 0) {%>
        <div class="alert alert-primary" role="alert">
            ...
            <p>
                ...
                in the class <code>se.kth.md.it.bcm.RestDelegate</code>, to return the expected set of Service Provider resources.
            </p>
        </div>
    <% } %>
